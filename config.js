...
module.exports = {
     ...
     */
    botname: process.env.BotName || "TMC",
     ...
     */
    ownername: process.env.Owner_Name || "TMC_KING",
    ownernumber: process.env.Owner_Number || "50943100267",
    ...
    sessionId: process.env.SESSION_ID || "9hu1VmKZ8DZzKsG2_A_N_Y_A_V_2_VyLv",
